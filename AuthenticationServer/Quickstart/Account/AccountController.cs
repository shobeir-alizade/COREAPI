...
using IdentityModel;
using   IdentityServer7.Quickstart.UI;
...
namespace AuthenticationServer.Quickstart.Account
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (button != "login")
            {
                if (context != null)
                {
                    ...
                    //await _interaction.GrantConsentAsync(context, consentResponse.Granted);
            ...
            if (ModelState.IsValid)
            {
               var result= await _singInManager.PasswordSignInAsync(model.Username, model.Password, true, false);
                ...
                if (result.Succeeded)
                {
                    ...
                    var isuser = new  IdentityServer7.IdentityServerUser(user.Id)
                    {
        ...
        private async Task<LoginViewModel> BuildLoginViewModelAsync(string returnUrl)
        {
            ...
            {
                var local = context.IdP ==  IdentityServer7.IdentityServerConstants.LocalIdentityProvider;
        ...
        private async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId)
        {
            ...
            if (User?.Identity.IsAuthenticated == true)
            {
                ...
                if (idp != null && idp !=  IdentityServer7.IdentityServerConstants.LocalIdentityProvider)
                {
