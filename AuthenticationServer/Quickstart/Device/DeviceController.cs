...
//namespace IdentityServer7.Quickstart.UI.Device
//{
//    [Authorize]
//    [SecurityHeaders]
...
//                    // emit event
//                    await _events.RaiseAsync(new ConsentGrantedEvent(User.GetSubjectId(), request.Client.ClientId, request.sc, grantedConsent.ScopesConsented, grantedConsent.RememberConsent));
//                }
//                else
//                {
...
//                {
//                    GetOfflineAccessScope(vm.ScopesConsented.Contains(  IdentityServer7.IdentityServerConstants.StandardScopes.OfflineAccess) || model == null)
//                });
//            }
...
//        public ScopeViewModel CreateScopeViewModel(IdentityServer7.Models.mo.ApiScope scope, bool check)
//        {
//            return new ScopeViewModel
//            {
//                Name = scope.Name,
...
//            return new ScopeViewModel
//            {
//                Name = IdentityServer7.IdentityServerConstants.StandardScopes.OfflineAccess,
